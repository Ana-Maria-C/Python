...
Aplicația primește la intrare versiunea curentă a unui fisier binar, precum si mai multe versiuni
precedente ale acestuia si creaza o lista de comenzi (de tipul insert / delete /change) prin care se poate ajunge de
la unul din fișierele precedente la fișierul curent.

Lista în cauză este encodata într-un fișier binar.
Cu acel fișier binar, pornind de la unul dintre fișierele cu versiune mai veche, se poate obține fișierul cel mai nou.
